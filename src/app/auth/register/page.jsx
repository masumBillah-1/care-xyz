...
import { Eye, EyeOff, Mail, Lock, User, Phone, CreditCard, Heart } from 'lucide-react'
...
function RegisterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Fallback to NextAuth registration
      try {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      await signInGoogle()
      toast.success('Successfully signed up with Google!', { id: loadingToast })
      router.push('/')
    } catch (error) {
      console.error('Firebase Google Sign-Up failed:', error)
      
      // Fallback to NextAuth Google Sign-In
      try {
        ...
        console.error('NextAuth Google Sign-Up also failed:', nextAuthError)
        toast.error('Google Sign-Up is not available. Please use the registration form.', { id: loadingToast })
      }
    }
  }
