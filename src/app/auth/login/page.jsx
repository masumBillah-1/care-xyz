...
function LoginForm() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      await signInGoogle()
      toast.success('Successfully signed in with Google!', { id: loadingToast })
      router.push(callbackUrl)
    } catch (error) {
      ...
      try {
        ...
        console.error('NextAuth Google Sign-In also failed:', nextAuthError)
        toast.error('Google Sign-In is not available. Please use email/password login.', { id: loadingToast })
      }
    }
  }
